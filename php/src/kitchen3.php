...
<body> 
    <div class="banner">
        ...
        <div class="img">
            ...
            <div class="arrowleft" style="left:50px; bottom:140px; font-size: 25px; color: yellow;">Container</div>
            <div class="arrowright" style="left:190px; bottom:170px; font-size: 25px; color: yellow;">Pots</div>
        </div>
        ...
        <div>
            <p><pre style="font-size:22px;color:white;padding-left: 3%;padding-top: 30px;">
                ...
                kitchen gardens (Eg:- Herbs, Leafy greens, Fruits and vegetables, Flowers), and a few pots and
                containers, that can be used to plant these plants.

                In a kitchen of size 5 ft x 10 ft, to grow a similar kitchen garden, you will need 10-20 plants,
                some in containers and some in pots, seeds and a watering can.
