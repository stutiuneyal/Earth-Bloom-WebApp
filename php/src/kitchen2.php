...
<body> 
    <div class="banner">
        ...
        <div class="img">
            ...
            <div class="arrowright" style="left:30px; bottom: 230px; font-size: 25px; color: yellow;">Thyme Plant</div>
            <div class="arrowright" style="left:130px; bottom: 230px; font-size: 25px; color: yellow;">Parsley Plant</div>
            <div class="arrowleft" style="left:200px; bottom:120px; font-size: 25px; color: yellow;">Pots</div>
        </div>

        <div>
            <p><pre style="font-size:22px;color:white;padding-left: 3%;padding-top: 30px;">
                For making a kitchen garden as shown in the image, you will require thyme and parsley plants,
                along with a few pots. Thyme and parsley can be grown and then used in the kitchen for cooking
                purposes.

                In a kitchen of size 5 ft x 10 ft, to grow a similar kitchen garden, you will need 5-6 plants
                (thyme, parsley, and other herbs), a few pots to plant them in, seeds and a watering can.
